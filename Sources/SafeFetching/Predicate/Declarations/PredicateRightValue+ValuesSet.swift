...
//            Builders.Predicate<Entity>(keyPath: $0, operatorString: "IN", value: values)
//        }
//    }
//
//    static func isNotIn(_ values: Value...) -> Builders.KeyPathPredicateRightValue<Entity, Value, [Value]> {
//        Builders.KeyPathPredicateRightValue {
//            .init(keyPath: $0, operatorString: "IN", value: values, isInverted: true)
//        }
//    }
//
//    static func isIn(_ values: [Value]) -> Builders.KeyPathPredicateRightValue<Entity, Value, [Value]> {
//        Builders.KeyPathPredicateRightValue { .init(keyPath: $0, operatorString: "IN", value: values) }
//    }
//
//    static func isNotIn(_ values: [Value]) -> Builders.KeyPathPredicateRightValue<Entity, Value, [Value]> {
//        Builders.KeyPathPredicateRightValue { .init(keyPath: $0, operatorString: "IN", value: values, isInverted: true) }
//    }
//}
